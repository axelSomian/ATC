...
- 2026-09-20 (essai 3) : trigger OK (dispatch reçu par `Template-PW-automation`) mais
  les tests Playwright échouaient côté template ; correctif appliqué côté
  `Template-PW-automation`, on relance pour vérifier.
